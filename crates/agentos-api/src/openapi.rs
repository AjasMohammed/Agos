...
#[openapi(
    ...
    paths(
        ...
        crate::handlers::notifications::clear_all,
        ...
        crate::handlers::workspace_grants::list,
        crate::handlers::workspace_grants::add,
        crate::handlers::workspace_grants::revoke,
        ...
        crate::handlers::plugins::install,
        crate::handlers::plugins::discover,
        crate::handlers::plugins::detail,
        crate::handlers::plugins::update,
        crate::handlers::plugins::remove,
        crate::handlers::plugins::enable,
        crate::handlers::plugins::disable,
        crate::handlers::channels::list,
        crate::handlers::channels::connect,
        crate::handlers::channels::detail,
        crate::handlers::channels::update,
        crate::handlers::channels::disconnect,
        crate::handlers::channels::test,
        crate::handlers::channels::set_agent,
        crate::handlers::channels::pairings,
        crate::handlers::channels::approve_pairing,
        crate::handlers::channels::approve_pending_pairing,
        crate::handlers::channels::revoke_pairing,
        crate::handlers::mcp::list,
        crate::handlers::mcp::attach,
        crate::handlers::mcp::update,
        crate::handlers::mcp::detach,
        crate::handlers::mcp::catalog_list,
        crate::handlers::mcp::catalog_detail,
        crate::handlers::mcp::catalog_install,
        crate::handlers::connectors::list,
        crate::handlers::connectors::add,
        crate::handlers::connectors::detail,
        crate::handlers::connectors::update,
        crate::handlers::connectors::remove,
        crate::handlers::connectors::disconnect,
        crate::handlers::connectors::oauth_start,
        crate::handlers::connectors::oauth_callback,
        crate::handlers::connectors::store_credential,
    ...
    components(schemas(
        ...
        crate::types::InstallPluginRequest,
        crate::types::ConnectChannelRequest,
        crate::types::SetChannelAgentRequest,
        crate::types::UpdateChannelRequest,
        crate::types::ApiPairings,
        crate::types::ApiPairingEntry,
        crate::types::ApiPendingPairing,
        crate::types::AttachMcpRequest,
        crate::types::McpAttachedResponse,
        crate::types::ApiMcpCatalogEntry,
        crate::types::InstallMcpRequest,
        crate::types::AddConnectorRequest,
        crate::types::OAuthStartResponse,
        crate::types::StoreCredentialRequest,
